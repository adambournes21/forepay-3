...
import { fetchUsername, createMessage, fetchThreadName, listenToMessages } from '../firebaseConfig.js';
...
const ChatScreen = ({navigation, route}) => {
    ...
    return (
        <View style={{display: 'flex', justifyContent: 'flex-start', alignItems: 'center', 
                    height: '100%', width: '100%', backgroundColor: 'white', paddingTop: 45}}>
            <View style={{display: 'flex', width: '80%', flexDirection: 'row',
                    justifyContent: 'space-between', alignItems: 'center',
                    marginTop: '5%', marginBottom: '0%'
                    }}>
                <TouchableOpacity onPress={() => navigation.pop()} style={{flex: 10, alignItems: 'center', marginLeft: -40}}>
                    <Image source={require('../images/back.png')}
                        style={{width: 23, height: 23}} />
                </TouchableOpacity>
                <Text style={{fontSize: 23, fontFamily: 'Arial', flex: 20, textAlign: 'center', marginLeft: 10}}>{threadName}</Text>
                <TouchableOpacity onPress={() => navigation.navigate('AddUser', { threadID: threadID, threadName: threadName, username: username })} style={{flex: 5, alignItems: 'center'}}>
                    <Image source={require('../images/add-contact.png')}
                        style={{width: 20, height: 20}} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => navigation.navigate('ChatRoster', { threadID: threadID, threadName: threadName, username: username })} style={{flex: 5, alignItems: 'center', marginRight: -20}}>
